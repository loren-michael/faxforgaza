            ...
            <div class="container mx-auto py-8">
                        ...
                        <div class="bg-white shadow rounded-lg p-6">
                            <div class="flex flex-col items-center">
                                ...
                                <div class="mt-6 flex flex-wrap gap-4 justify-center">
                                    ...
                                    <a href="/" class="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded font-merriweather">Resume</a>
                                </div>
                            </div>
                ...
                <div class="col-span-4 sm:col-span-9">
                    ...
                    <div class="flex justify-center items-center gap-6 my-6">
                        <a class="text-blue-600 hover:text-orange-600" aria-label="Visit Loren's LinkedIn" href="https://www.linkedin.com/in/lorenhartman/"
                        ...
                        <a class="text-gray-700 hover:text-orange-600" aria-label="Visit Loren's GitHub" href="https://github.com/loren-michael"
                            target="_blank" rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="h-6">
                                <path fill="currentColor"
