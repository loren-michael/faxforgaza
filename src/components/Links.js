...
{/* FaxZero Reps */}
                <div class="mb-6">
                  <div class="flex justify-between">
                    <a href="https://faxzero.com/fax_congress.php" class="text-green-800 font-bold" target="_blank" rel="noopener noreferrer">FaxZero Representatives</a>
                  </div>
...
{/* FaxZero Sens */}
                <div class="mb-6">
                  <div class="flex justify-between">
                    <a href="https://faxzero.com/fax_senate.php" class="text-green-800 font-bold" target="_blank" rel="noopener noreferrer">FaxZero Senators</a>
                  </div>
...
{/* Official Rep Lookup */}
                <div class="mb-6">
                  <div class="flex justify-between">
                    <a href="https://www.congress.gov/members/find-your-member" class="text-green-800 font-bold" target="_blank" rel="noopener noreferrer">Congress.gov Representative Lookup</a>
                  </div>
...
{/* House Summary */}
                <div class="mb-6">
                  <div class="flex justify-between">
                    <a href="https://www.congress.gov/bill/118th-congress/house-resolution/786" class="text-green-800 font-bold" target="_blank" rel="noopener noreferrer">House Resolution 786 Summary</a>
                  </div>
...
{/* Co-Sponsors */}
                  <div class="mb-6">
                    <div class="flex justify-between">
                      <a href="https://www.congress.gov/bill/118th-congress/house-resolution/786/cosponsors" class="text-green-800 font-bold" target="_blank" rel="noopener noreferrer">HR 786 Co-Sponsors</a>
                    </div>
...
{/* BDS Movement */}
                  <div class="mb-6">
                    <div class="flex justify-between">
                      <a href="https://bdsmovement.net/" class="text-green-800 font-bold" target="_blank" rel="noopener noreferrer">BDS Movement</a>
                    </div>
...
{/* JVP */}
                  <div class="mb-6">
                    <div class="flex justify-between">
                      <a href="https://www.jewishvoiceforpeace.org/" class="text-green-800 font-bold" target="_blank" rel="noopener noreferrer">Jewish Voice for Peace</a>
                    </div>
