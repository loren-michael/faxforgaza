...
const NavBar = () => {
  return (
    <div class="h-20 bg-blue-400">
      ...
      <div>
        <a href="/resume" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0"> Resume </a>
      </div>
        </div>
      </nav>
    </div>
