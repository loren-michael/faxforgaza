...
const NavBar = () => {
  return (
    <div class="flex items-center justify-between flex-wrap bg-blue-500 p-6">
        ...
        <div class="text-sm lg:flex-grow">
          ...
          <a href="/resume" class="block mt-4 lg:inline-block lg:mt-0 text-blue-200 hover:text-white mr-4">
            Resume
          </a>
      ...
      <div>
        <a href="/resume" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-blue-600 hover:bg-white mt-4 lg:mt-0"> Resume </a>
      </div>
      </div>
    </div>
  )
