            ...
            <div class="bg-white shadow rounded-lg p-6">
              <div class="col-span-4 sm:col-span-9">
                <div class="bg-white shadow rounded-lg p-6">
                  ...
                  <YouTube videoId="4cvZbOYlLcg" opts={opts} onReady={onPlayerReady} id="sellit video"/>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                  ...
                  <YouTube videoId="NlN0V4Bq_yM" options={opts} onReady={onPlayerReady} id="movie rental video"/>                
                ...
                <div class="bg-white shadow rounded-lg p-6">
                  ...
                  <p class="text-gray-500 text-center font-merriweather">Ruby on Rails, React</p>
                  <YouTube videoId="IPAvHJ6HqBk" options={opts} onReady={onPlayerReady} id="character manager video"/>                
                ...
                <div class="bg-white shadow rounded-lg p-6">
                  ...
                  <YouTube videoId="7tJt0OAALhk" options={opts} onReady={onPlayerReady} id="recipe v2 video"/>                 
                ...
                <div class="bg-white shadow rounded-lg p-6">
                  ...
                  <YouTube videoId="93D8D1Pqez8" options={opts} onReady={onPlayerReady} id="recipe v1 video"/>                 
